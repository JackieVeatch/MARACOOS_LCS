...
for d = 1:numFallDay
    ...
    indDay = find(MARACOOS.dt >= uniqueDates_F(d) & MARACOOS.dt < uniqueDates_F(d)+days(1));
    u = MARACOOS.u(:,:,indDay);
    v = MARACOOS.v(:,:,indDay);
...
%%
    ...
    for i=uniqueDates_F(d):hours(1):uniqueDates_F(d)+hours(23)
...
save('MARACOOS_filled_2013_fall' , 'MARACOOS_filled');
