...
ncFile = '/home/jmv208/MAB/Maracoos_HFR/2013_totals_aggregated_postproc.nc';
...
conf.OI.BaseDir = '/home/jmv208/MATLAB/MAB/data/filled';
...
for d = 1:numWinterDays
    % index in time for one day
    indDay = find(MARACOOS.dt >= uniqueDates_W(d) & MARACOOS.dt < uniqueDates_W(d)+days(1));
    u = MARACOOS.u(:,:,indDay);
    v = MARACOOS.v(:,:,indDay);
...
%%
    ...
    for i=uniqueDates_W(d):hours(1):uniqueDates_W(d)+hours(23)
        ...
        addpath('/home/jmv208/MAB/toolbox_erick_fredj')
...
save('MARACOOS_filled_2013_winter' , 'MARACOOS_filled');
